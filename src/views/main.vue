                        ...
                        <div class="md-layout-item md-size-66 md-small-size-100 mx-auto">
                            ...
                            <h4>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                >ThemeIsle</a> created a Wordpress Theme which can be also downloaded for free. Start a new project or give an old Bootstrap project a new look!
                            </h4>
                        </div>
                        ...
                        <div class="md-layout-item md-size-66 md-small-size-100 mx-auto">
                            ...
                            <h4>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                >Vue Material Dashboard PRO</a>. It has a huge number of components, sections and example pages. Start Your Development With A Badass Bootstrap UI Kit inspired by Material Design.
                            </h4>
                        </div>
                        <div class="md-layout-item md-size-50 md-small-size-100 mx-auto">
